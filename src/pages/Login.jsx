...
import loginlogo from "../assets/MyCashLogo.png"
...
const Login = () => {
    return (
        <div className='w-full'>
                <div class=" max-w-2xl mt-10 border   mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
    <div class="px-6 py-4">
        <div class="flex justify-center mx-auto">
            <img class="w-auto h-7 sm:h-8" src={loginlogo} alt="logo"/>
        </div>

        <h3 class="mt-3 text-xl font-medium text-center text-gray-600 dark:text-gray-200">Welcome Back</h3>

        <p class="mt-1 text-center text-gray-500 dark:text-gray-400">Login your account</p>
    ...
    <div class="flex items-center justify-center py-4 text-center bg-gray-50 dark:bg-gray-700">
        ...
        <Link to={'/registation'} class="mx-2 text-sm font-bold text-blue-500 dark:text-blue-400 hover:underline">Register</Link>
    </div>
</div> 
        </div>
    );
